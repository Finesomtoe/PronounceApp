...
INSERT INTO `sentences_test` VALUES (1,'greeting','Hoe gaat het?','How is it going?','Hoe gaat?',0),(2,'transport','Hoe ver is het naar de parkeergarage','How far is it  to the parking garage?','Hoe ver?',0);
...
-- Dump completed on 2017-05-12 16:37:59
